...
/**
 * Immutable representation of an IPv6 network mask. A network mask is nothing more than an IPv6 address with a continuous range of 1 bits starting from the
 * most significant bit. A network mask can also be represented as a prefix length, which is the count of these 1 bits.
 * 
...
public final class IPv6NetworkMask implements Serializable {
     ...
     *             if the prefix length is not in the interval ]0, 128]
     */
     ...
     * @throws IllegalArgumentException
     *             if the address is not a valid network mask
