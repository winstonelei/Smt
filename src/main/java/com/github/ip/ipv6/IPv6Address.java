...
public final class IPv6Address implements Comparable<IPv6Address>, Serializable {
    ...
    /**
     * Construct an IPv6Address from two longs representing the 64 highest and 64 lowest bits. It is usually easier to construct IPv6Addresses from a
     * {@link String} or an {@link InetAddress}. The internal representation of an IPv6Address is exactly these two longs though, so if you already
     * happen to have them, this provides a very efficient way to construct an IPv6Address.
     * 
     * @param highBits
     *            highest order bits
     * @param lowBits
    ...
    /**
     * Create an IPv6 address from its String representation. For example "1234:5678:abcd:0000:9876:3210:ffff:ffff" or "2001::ff" or even "::". IPv4-Mapped IPv6
     * addresses such as "::ffff:123.456.123.456" are also supported.
     * 
     * @param string
     ...
     * 
     * @param bytes
     *            byte array with 16 bytes (interpreted unsigned)
     * @return IPv6 address
     */
    ...
    /**
     * Create an IPv6 address from a (positive) {@link BigInteger}. The magnitude of the {@link BigInteger} represents the IPv6 address
    ...
    /**
     * @return {@link BigInteger} representation. The magnitude of the {@link BigInteger} represents the IPv6 address value. Or in other
     *         words, the {@link BigInteger} with value N defines the Nth possible IPv6 address.
     */
    ...
    /**
     * Returns true if the address is an IPv4-mapped IPv6 address. In these addresses, the first 80 bits are zero, the next 16 bits are one, and the remaining
     * 32 bits are the IPv4 address.
     * 
    ...
    /**
     * Returns a string representation of the IPv6 address. It will use shorthand notation and special notation for IPv4-mapped IPv6 addresses whenever
     * possible.
     * 
    ...
    public int numberOfLeadingZeroes() {
        return highBits == 0 ? Long.numberOfLeadingZeros(lowBits) + 64 : Long.numberOfLeadingZeros(highBits);
    }
