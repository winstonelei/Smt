package com.github.slidewindow;
...
//        }
     ...
     */
    private void reset() {
        beginTimestamp =System.currentTimeMillis(); //SystemClock.now();
        //窗口个数
    ...
    private int locationIndex() {
        long now = System.currentTimeMillis();//SystemClock.now();
...
//        System.out.println("index:" + index);
        ...
        lastAddTimestamp = System.currentTimeMillis();//SystemClock.now();
