...
import com.github.netty.learning.productionIdel.ConnectionWatchdog;
import com.github.netty.learning.productionIdel.acceptor.AcknowledgeEncoder;
...
import com.github.netty.learning.productionIdel.common.NativeSupport;
import com.github.netty.learning.productionIdel.common.NettyCommonProtocol;
import com.github.netty.learning.productionIdel.common.exception.ConnectFailedException;
...
import static com.github.netty.learning.productionIdel.common.NettyCommonProtocol.*;
    ...
    class MessageHandler extends ChannelInboundHandlerAdapter {
		...
		public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
			...
			if(msg instanceof Acknowledge){
				System.out.println("收到server端的Ack信息，无需再次发送信息");
