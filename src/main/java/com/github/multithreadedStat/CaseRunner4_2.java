 ...
 */
package com.github.multithreadedStat;
...
/**
 * 运行程序前请先解压缩数据文件：InputFiles.zip。 <br>
 * 参考命令如下。
...
public class CaseRunner4_2 {
  ...
  private static Runnable createTask(InputStream in, int sampleInterval,
    ...
    taskClazz = null == taskClazz ? "com.github.multithreadedStat.MultithreadedStatTask"
        : taskClazz;
  ...
  private static InputStream createInputStream() throws FileNotFoundException {
    ...
    File file = new File("D:\\workspace\\javamtia-master\\JavaMultiThreadInAction\\src\\data\\ch4case02\\in.dat");
    InputStream dataIn =new FileInputStream(file);
            /*CaseRunner4_2.class
        .getResourceAsStream("D:\\workspace\\javamtia-master\\JavaMultiThreadInAction\\src\\data\\ch4case02\\in.dat");*/
    ...
    SequenceInputStream si = new SequenceInputStream(
        new Enumeration<InputStream>() {
          ...
          public InputStream nextElement() {
            ...
            if (null != fileName) {
              try {
                File file = new File("D:\\workspace\\javamtia-master\\JavaMultiThreadInAction\\src\\data\\ch4case02\\"
                        + fileName);
                in =new FileInputStream(file);
        /*        in = CaseRunner4_2.class.getResourceAsStream("D:\\workspace\\javamtia-master\\JavaMultiThreadInAction\\src\\data\\ch4case02\\"
                    + fileName);*/
              } catch (Exception e) {
                e.printStackTrace();
              }
